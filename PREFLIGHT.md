...
```yaml
# version: 0.4.0  # Previous version
...
Create a new release on GitHub. Use the tag you just created (e.g., `v0.5.0`). Copy the relevant section from `CHANGELOG.md` into the release notes.
